...
def main(jsfile, funcfile):
    ...
    #ex: file.js_func.csv
    csvfile = jsfile+'_call.csv'
    #ex: file.js_rda.csv
    rdafile = jsfile+'_rda.csv'
    #ready for mergeFunCall
    finalCsv = jsfile+'_finalcall.csv'
